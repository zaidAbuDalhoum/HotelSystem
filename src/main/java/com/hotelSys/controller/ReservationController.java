...
public class ReservationController {
    ...
    public ModelAndView reservationConfirmation(HttpServletRequest request, HttpServletResponse response,
                                                @PathVariable int id) {
    ...
    public ModelAndView reservationProcess(HttpServletRequest request, HttpServletResponse response,
        ...
        roomDaoImpl.reserveRoom((Room) session.getAttribute("room"),
                (ReservationWrapper) session.getAttribute("reservationWrapper"), (Integer) session.getAttribute("id"));
