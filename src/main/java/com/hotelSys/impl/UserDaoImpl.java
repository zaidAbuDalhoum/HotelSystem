...
public class UserDaoImpl implements UserDao {
    ...
    public void register(User user) {
        final String INSERT = "INSERT INTO users(usersFirstName,usersLastName,usersEmail,usersPassword,usersPermission," +
        ...
        jdbcTemplate.update(INSERT, new Object[]{user.getFirstName(),
                user.getLastName(), user.getEmail(),encrypt(user.getPassword()), user.getPermission(), user.getPhoneNumber(),
